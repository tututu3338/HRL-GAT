class Config:
    def __init__(self):
        ...
        self.gat_heads = 8
        self.gat_epochs = 500
        self.lambda_smooth = 0.1       # Smoothing loss weight (Paper Eq.12)
        
        # RL configuration
        self.k_seeds = 50              # Maximum seed budget
        self.candidate_multiplier = 6  # Candidate pool multiplier c (Paper Eq.17)
        self.rl_epochs = 50            # Number of training episodes
        self.batch_size = 64
        self.lr = 3e-4
        self.gamma = 0.99              # Discount factor
        self.gae_lambda = 0.95         # GAE lambda
        self.clip_ratio = 0.2          # PPO clip epsilon (Paper Eq.20)
